...
_val = 0;
_val2 = (int) (0);
 //BA.debugLineNum = 19;BA.debugLine="val = -40";
_val = (int) (-40);
...
public static String  _reset_click() throws Exception{
 ...
 //BA.debugLineNum = 267;BA.debugLine="val = -40";
_val = (int) (-40);
 //BA.debugLineNum = 268;BA.debugLine="val2 =  0";
_val2 = (int) (0);
...
_secondint = 0;
_thirdint = 0;
 //BA.debugLineNum = 253;BA.debugLine="firstInt = Ceil(val2/8)+45";
_firstint = (int) (anywheresoftware.b4a.keywords.Common.Ceil(_val2/(double)8)+45);
